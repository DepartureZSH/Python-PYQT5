...
from PyQt5.QtWidgets import QApplication, QWidget, QComboBox, QFontComboBox, QLabel, QMessageBox, QVBoxLayout


class Demo(QWidget):
    choice = '10'
    choice_list = ['20', '30', '40', '50']
    ...
    def __init__(self):
        ...
        self.label = QLabel('张', self)                                         # 实例化一个单行文本输入框，输入框中字体会根据以上选择发生变化
        font = QFont('微软雅黑', 30)
        font.setPixelSize(50)
        self.label.setFont(font)
        # self.label.setFont(QFont('宋体', 50))
